...
class Fluid_Solver_2D : public Simulation
{
public:
    Fluid_Solver_2D(double dx, int nx, int ny, World& world, double dt);
...
private:
    ...
    std::unordered_map<ecs::Entity, glm::dvec2> previous_particle_grid_residuals_;
